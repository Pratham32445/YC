...
const Founders = () => {
  return (
    <div className="max-w-3xl mx-auto mt-36">
      <h1 className="text-center text-3xl font-bold mb-2">Excellent Founders</h1>
      <p className="text-center text-lg text-gray-600 mb-12">The visionaries behind Y Combinator</p>
            ...
            <div className="w-full md:w-1/2 px-4">
              ...
              <ul className="space-y-2 mb-6">
                {founder.description.map((item, i) => (
                  <li key={i} className="text-sm text-neutral-500">{item}</li>
                ))}
              </ul>
              
              <div className="flex items-center gap-4 mt-5">
                {founder.socialHandle.FaXTwitter && (
                  <a href={founder.socialHandle.FaXTwitter} target="_blank" rel="noopener noreferrer">
                    <FaXTwitter size={20} />
                  </a>
                )}
                {founder.socialHandle.FaLinkedin && (
                  <a href={founder.socialHandle.FaLinkedin} target="_blank" rel="noopener noreferrer">
                    <FaLinkedin size={20} />
                  </a>
                )}
              </div>
